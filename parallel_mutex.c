...
pthread_mutex_t global_lock;  // Define a global lock

void insert(int key, int val) {
  pthread_mutex_lock(&global_lock); // Lock to ensure serialized insertion across all buckets
  ...
  pthread_mutex_unlock(&global_lock); // Unlock after insertion
}
